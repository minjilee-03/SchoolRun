...
public class Select_Nari extends JFrame {
	...
	public Select_Nari() {
		...
		g1.setIcon(new ImageIcon("..//image//game_image//nari_1_select.png"));
		JButton g2 = new JButton("");
		g2.setIcon(new ImageIcon("..//image//game_image//nari_2_select.png"));
		JButton g3 = new JButton("");
		g3.setIcon(new ImageIcon("..//image//game_image//nari_3_select.png"));
		...
		g1.addActionListener( new ActionListener() { //c_btn을 누르면 동작하는 메서드
			...
			public void actionPerformed(ActionEvent arg0) {
				String cr1 = "..//image//game_image//nari_1.gif"; //기본
				String cr2 = "..//image//game_image//nari_1_jump.png"; //점프
				String cr3 = "..//image//game_image//nari_1_jump2.gif"; //더블점프
				String cr4 = "..//image//game_image//nari_1_fall.png"; //낙하
				String cr5 = "..//image//game_image//nari_1_slide.png"; //슬라이드
		...
		g2.addActionListener( new ActionListener() { //c_btn을 누르면 동작하는 메서드
			@Override
			public void actionPerformed(ActionEvent arg0) {
				String cr1 = "..//image//game_image//nari_2.gif"; //기본
				String cr2 = "..//image//game_image//nari_1_jump.png"; //점프
				String cr3 = "..//image//game_image//nari_1_jump2.gif"; //더블점프
				String cr4 = "..//image//game_image//nari_1_fall.png"; //낙하
				String cr5 = "..//image//game_image//nari_1_slide.png"; //슬라이드
		...
		g3.addActionListener( new ActionListener() { //c_btn을 누르면 동작하는 메서드
			@Override
			public void actionPerformed(ActionEvent arg0) {
				String cr1 = "..//image//game_image//nari_3.gif"; //기본
				String cr2 = "..//image//game_image//nari_1_jump.png"; //점프
				String cr3 = "..//image//game_image//nari_1_jump2.gif"; //더블점프
				String cr4 = "..//image//game_image//nari_1_fall.png"; //낙하
				String cr5 = "..//image//game_image//nari_1_slide.png"; //슬라이드
